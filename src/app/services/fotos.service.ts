...
import { API_CONFIG } from '../config/api.config'; // Importe a configuração
...
export class FotosService {
  ...
  private apiUrl = `${API_CONFIG.baseUrl}/api/fotos`; 
  ...
  // Método para fazer o GET das últimas 5 fotos do carrossel
